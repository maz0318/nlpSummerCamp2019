...
val = json.load(open('/home/maz/Documents/data/coco/annotations/captions_train2014.json', 'r'))
train = json.load(open('/home/maz/Documents/data/coco/annotations/captions_val2014.json', 'r'))
...
for subset in split:
	...
	json.dump(json_data[subset], open('/home/maz/Documents/data/coco/annotations/karpathy_split_' + subset + '.json', 'w'))